...
class Stereotypes(abstractEvaluator):
    ...
    def detect_stereotypes(self, tokens):
    ...
    def calculate_stereotype_score(self, detected_stereotypes, tokens):
    ...
    def evaluate(self, file_path):
        ...
        stereotypes= self.detect_stereotypes(tokens)
        score = self.calculate_stereotype_score(stereotypes,tokens)
        return score
